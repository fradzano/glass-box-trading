...
import type { InvocationOutcome } from "./plan.ts";
  ...
  switch (outcome.kind) {
    ...
    case "aborted":
      return [
        ...
        outcome.teardown ? "both tasks are disabled and the certificate line is unset" : "the armed run was left as it is; tearing it down is the owner's decision",
