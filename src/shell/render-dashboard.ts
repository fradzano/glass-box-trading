...
*{box-sizing:border-box}body{margin:0;background:var(--paper);color:var(--ink);font:15px/1.5 Georgia,"Times New Roman",serif}
...
code,td.num,.figure code{font-family:"SF Mono",Consolas,"Liberation Mono",monospace;font-size:.92em}
...
.tile{border:1px solid var(--rule);padding:.75rem 1rem;background:#fff}.tile .eyebrow{display:block;margin-bottom:.25rem}.tile strong{font-size:1.35rem;font-family:"SF Mono",Consolas,monospace}
table{border-collapse:collapse;width:100%;font-size:.9rem;margin:.75rem 0}th,td{text-align:left;padding:.35rem .5rem;border-bottom:1px solid var(--rule);vertical-align:top}th{font-family:Arial,sans-serif;font-size:.75rem;text-transform:uppercase;letter-spacing:.08em;color:var(--mute)}td.num{text-align:right}
...
.rationale{font-style:italic;margin:.5rem 0}.chain{margin:0}.chain div{display:grid;grid-template-columns:8rem 1fr;gap:.5rem;padding:.35rem 0;border-top:1px dotted var(--rule)}.chain dt{font-family:Arial,sans-serif;font-size:.78rem;text-transform:uppercase;color:var(--mute)}.chain dd{margin:0}
