...
(1) Frisches Alpaca-Paper-Konto anlegen, nur für den Agenten, Options Level 3. Es muss am oder nach Samstag 05.09.2026 02:00 Europe/Berlin erstellt worden sein (COMPETITION_START), sonst verweigert der Provenance-Beweis. Direkt danach node tools\probe-provenance.mjs competition ausfuehren — liest nur, schreibt nichts, und beantwortet die Frage sofort statt am Ankertag.
