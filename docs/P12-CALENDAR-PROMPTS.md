...
(3) Drei Healthchecks anlegen (liveness, readiness, watchdog) mit den exakten Cron-Ausdrücken, die tools\install-scheduled-task.ps1 -WhatIf ausgibt, und danach tools\check-alert-path.ps1 laufen lassen und den Empfang auf dem Handy bestätigen.
...
Time: 15:15–17:00, timezone Europe/Berlin
Description: Beaufsichtigt, während der US-Marktzeiten, auf dem DEV-Konto, gegen die endgültige Konfiguration. Beide Scheduled Tasks müssen vorher deaktiviert sein. Der PowerShell-Block in docs\P12-RUNBOOK.md, Owner step 4, setzt die Dev-Variablen nur für diesen Lauf und stellt sie auch bei Fehlern wieder her. Erwartet: verdict PASS und flaches Dev-Konto. Danach den ausgegebenen Zertifikatspfad als PRE_ARM_CERTIFICATE in .env eintragen und das Fenster schließen.
Abbruch, wenn das Verdikt nicht PASS ist: dann findet am 9.9. kein erster Zyklus statt und alle Folgetermine verschieben sich.
...
Time: 15:20–22:15, timezone Europe/Berlin
