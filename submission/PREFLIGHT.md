...
| Video upload: MP4, under five minutes, under 300 MB | Submission form file upload | Download the uploaded file back; check duration and file size | Local pre-upload facts (ffprobe): `submission/glass-box-trading.mp4`, h264 1920x1080 30 fps + silent AAC, duration 299.05 s (< 300 s), 48,319,731 bytes (46.1 MB < 300 MB); rendered by `npm run render` in `video/` from the frozen dataset, five captures named in `meta.captures`; archived in the verification store `evidence/submission-2026-09-04/`. Form-side half: owner step at form time | 2026-09-04T08:58:00Z |
