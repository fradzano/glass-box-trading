...
| Video upload: MP4, under five minutes, under 300 MB | Submission form file upload | Download the uploaded file back; check duration and file size | Local pre-upload facts (ffprobe, narrated second cut): `submission/glass-box-trading.mp4`, h264 1920x1080 30 fps + AAC 48 kHz voice-over, duration 299.03 s (< 300 s), 48,429,177 bytes (46.2 MB < 300 MB); rendered by `npm run render` in `video/` from the frozen dataset, five captures and nine narration files named in meta.json; archived in the verification store `evidence/submission-2026-09-04/`. Form-side half: owner step at form time | 2026-09-04T10:30:00Z |
