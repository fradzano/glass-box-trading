...
import { ACCOUNT, DIGEST_A, DIGEST_B, entry, gateVector, inputs, LEGS, LONG, observations, order, ORIGIN, passingJournal, sample, SHORT, snapshot } from "./arm01-fixtures.js";
import type { OrderObservation } from "../src/core/certificate.js";
